...
namespace Common.Library
{
    public class StringHelper
    {
        ...
        /// </summary>
        /// <param name="maxLength">How long to make the resulting string</param>
        /// <returns>A random set of values</returns>
        public static string CreateRandomString(int maxLength)
        {
            const string charList = @"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@";
            ...
            for (var i = maxLength; i > 0; i--)
            {
                ...
                sb.Append(charList[(int)(num % (uint)charList.Length)]);
            }
